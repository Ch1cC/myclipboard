...
install_file() {
  ...
  mkdir /usr/local/etc/myclipboard/static
  curl -x "${PROXY}" -R -H 'Cache-Control: no-cache' -o "/usr/local/etc/myclipboard/static/index.html" https://raw.githubusercontent.com/Ch1cC/myclipboard/main/static/index.html
}
